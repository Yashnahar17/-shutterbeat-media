#!/bin/bash
# ============================================================
#  ShutterBeat Media — Services Overview Page
#  Run from PROJECT ROOT:  bash shutterbeat-services-page.sh
# ============================================================
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║   ShutterBeat — Services Overview Page      ║"
echo "╚══════════════════════════════════════════════╝"
echo ""

mkdir -p src/pages

echo "📄  Writing src/pages/Services.jsx ..."

cat > src/pages/Services.jsx << 'PAGE_EOF'
...
function ServiceCard({ s, index }) {
  ...
  return (
    <Motion.div
      ...
      className="group relative bg-dark-800 border rounded-2xl overflow-hidden flex flex-col transition-all duration-300"
      style={{
        borderColor: hovered ? s.accentBorder : 'rgba(255,255,255,0.06)',
      ...
      <div className="p-7 flex flex-col flex-1">
        ...
        <div className="flex items-start justify-between mb-6">
          <div
            ...
            style={{
              background: hovered ? s.accentBg : 'rgba(255,255,255,0.04)',
              border: `1px solid ${hovered ? s.accentBorder : 'rgba(255,255,255,0.08)'}`,
            }}
          >
            <s.Icon size={20} style={{ color: hovered ? s.accent : 'rgba(255,255,255,0.35)', transition: 'color 0.3s' }} />
          </div>
          <span
        ...
        {/* Title + tagline */}
        <h3 className="font-heading text-white text-xl mb-2 transition-colors duration-200"
          style={{ letterSpacing: '-0.02em' }}>
          {s.title}
        </h3>
        <p className="text-white/35 font-body text-sm italic mb-4" style={{ color: hovered ? 'rgba(255,255,255,0.5)' : undefined, transition: 'color 0.3s' }}>
          "{s.tagline}"
        </p>
        ...
        <div className="flex items-center justify-between pt-5 border-t"
          ...
          <div>
            <div className="font-heading text-white text-lg font-bold" style={{ color: s.accent }}>
              {s.stat.value}
            </div>
            <div className="text-white/30 font-body text-xs">{s.stat.label}</div>
          </div>
          <Link
            to={s.href}
  ...
  return (
    <div className="bg-dark-900 min-h-screen">
      ...
      <section className="relative min-h-[52vh] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary/15 via-dark-800/50 to-secondary/10" />
        ...
        <div className="container-custom relative z-10 pt-40 pb-16">
          <Motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="font-heading text-display text-white mb-5 leading-tight max-w-3xl"
              style={{ letterSpacing: '-0.025em' }}>
              One Roof.<br />
              <span className="text-gradient">Every Creative Need.</span>
            </h1>
            <p className="text-white/45 font-body text-xl max-w-2xl leading-relaxed mb-8">
            ...
            <div className="flex flex-wrap gap-6">
              {[
                ...
                <Motion.div key={i}
                  ...
                  <span className="font-heading text-white text-2xl font-bold">{s.v}</span>
                  <span className="text-white/30 font-body text-sm">{s.l}</span>
                </Motion.div>
              ))}
            </div>
          </Motion.div>
      ...
      {/* ── Filter bar ───────────────────────────── */}
      <section className="sticky top-16 z-20 bg-dark-900/95 backdrop-blur-lg border-b border-dark-600 py-4">
        <div className="container-custom">
          <div className="flex items-center gap-2 overflow-x-auto scrollbar-none">
            <span className="text-white/20 font-body text-xs tracking-widest uppercase shrink-0 mr-1">Filter:</span>
            {CATEGORIES.map(cat => (
              <button
                key={cat}
                ...
                style={{
                  ...
                  borderColor: activeCategory === cat ? '#485AA8' : 'rgba(255,255,255,0.1)',
      ...
      <section className="section-padding bg-dark-900">
        <div className="container-custom">
          <Motion.p
            ...
            className="text-white/20 font-body text-sm mb-10"
          >
            {activeCategory === 'All'
      ...
      <section className="section-padding bg-dark-800 border-t border-dark-600">
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-dark-600 rounded-2xl overflow-hidden border border-dark-600">
            {PROCESS.map((step, i) => (
              <Motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                className="bg-dark-800 p-8 hover:bg-dark-700 transition-colors duration-200 group"
              >
                <div className="font-heading text-primary/30 text-4xl font-bold mb-4 group-hover:text-primary/50 transition-colors">
                  {step.n}
                </div>
                <h3 className="font-heading text-white text-base mb-3">{step.title}</h3>
                <p className="text-white/35 font-body text-sm leading-relaxed">{step.desc}</p>
              </Motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Motion.div
              ...
              <p className="text-white/40 font-body text-lg leading-relaxed mb-8">
              ...
              {SERVICES.map((s, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-white/50 font-body text-xs text-center leading-tight group-hover:text-white transition-colors">
                      {s.title}
                    </span>
                  </Link>
                </Motion.div>
      ...
      <section className="section-padding bg-dark-800 border-t border-dark-600">
        <div className="container-custom">
          ...
          >
            ...
            <blockquote className="font-heading text-white text-2xl lg:text-3xl leading-snug mb-6"
              style={{ letterSpacing: '-0.02em' }}>
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 rounded-full bg-primary/20 border border-primary/30 flex items-center justify-center">
                <span className="font-heading text-white text-sm font-bold">VN</span>
              </div>
              <div className="text-left">
                <p className="text-white font-body text-sm font-semibold">Vikram Nair</p>
                <p className="text-white/35 font-body text-xs">CMO, DriveX Motors</p>
              </div>
            </div>
          </Motion.div>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
                ...
                <span className="text-white/60 font-body text-sm">Ready when you are</span>
              </div>
              <h2 className="font-heading text-h2 text-white mb-4">
                Let's Build Something <span className="text-gradient">Unforgettable</span>
              </h2>
              <p className="text-white/40 font-body text-lg max-w-xl mx-auto mb-10">
...
echo "║   <Route path=\"/services\" element={<Services />} />    ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
