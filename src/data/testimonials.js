...
export const testimonialsByService = {
  ...
  advertising: [
    { id:1, name:'Amit Joshi',       role:'Marketing Head, RetailCo',      text:'Our Diwali campaign ROI tripled. ShutterBeat Media understood our audience better than our internal team.', rating:5 },
  ...
  events: [
    ...
    { id:3, name:'DJ Karan',         role:'Performing Artist',             text:'ShutterBeat Media got me 3 festival bookings in one quarter. Their artist management is world-class.', rating:5 },
  ...
  'film-making': [
    ...
    { id:4, name:'Arjun Kulkarni',   role:'Film Festival Organiser',       text:'Voices of Pune was a standout submission. ShutterBeat Media has real storytelling talent.', rating:5 },
  ],
  branding: [
    ...
    { id:4, name:'Rohan Patel',      role:'Founder, QuickDeliver',         text:'ShutterBeat Media nailed our brand personality. The visual system scales perfectly across app and marketing.', rating:5 },
  ],
  'web-development': [
  ...
  music: [
    { id:1, name:'Neha Sharma',      role:'Independent Artist',            text:'Recording my EP at ShutterBeat Media Studio was a dream. The sound engineers really understood my vision.', rating:5 },
  ...
  consultation: [
    ...
    { id:4, name:'Rohan Patel',      role:'Founder, QuickDeliver',         text:'ShutterBeat Media helped us define our positioning when we were just an idea. Invaluable strategic partner.', rating:5 },
  ],
}
