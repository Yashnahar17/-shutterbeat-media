    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative min-h-[58vh] sm:min-h-[65vh] flex items-end pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="container-custom relative z-10 pt-32 sm:pt-40">
          <Motion.div initial={{ opacity:0, y:40 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8 }} className="max-w-4xl rounded-[1.5rem] border border-primary/12 bg-white/72 backdrop-blur-sm px-6 py-7 sm:p-9 shadow-[0_20px_44px_rgba(72,90,168,0.14)]">
            ...
            <Link to="/contact" className="btn-primary text-base px-8 py-4 shadow-[0_16px_34px_rgba(72,90,168,0.24)]">Work With Us <ArrowRight size={18}/></Link>
          </Motion.div>
        </div>
      </section>
              ...
              <Motion.div key={a.id} initial={{ opacity:0, y:30 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }} transition={{ delay:i*0.1 }}
                ...
                {a.image ? (
                  <SafeImage
                    ...
                    loading="lazy"
                    decoding="async"
                    className="w-16 h-16 rounded-full border-2 border-secondary/30 object-cover shrink-0 group-hover:border-secondary transition-colors"
                    fallback={
      ...
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          ...
          <Link to="/contact" className="btn-primary text-base px-8 py-4 shadow-[0_16px_34px_rgba(72,90,168,0.24)]">Start Your Music Journey <ArrowRight size={18}/></Link>
        </div>
      </section>
    </div>
  )
